        ...
        <div className="bg-[#111111] text-center sm:text-left min-h-fit">
            ...
            <div className="my-4 inline-block sm:block">
                <div className="inline-block">
                    <label className="h-fit w-fit ml-6">Pre-Built Templates:</label>
                </div>
                <div className="inline-block">
                    <select value={key} className="h-fit w-fit ml-3 mr-6 text-gray-900" onChange={onKeyChange}>
            ...
            <div className="my-4 inline-block sm:block">
                <div className="inline-block">
                    <label className="h-fit w-fit ml-6 mr-3 text-gray-400">Speed:</label>
                </div>
                ...
                <div className="inline-block w-16">
                    <label className="h-fit ml-4 px-3 py-1 text-center border border-blue-500 rounded text-white">
